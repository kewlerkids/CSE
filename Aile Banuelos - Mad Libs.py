...
male_name1 = input("Enter a male name: ")
adjective4 = input("Enter an adjective: ")

print("A young boy named %s heard of this house." % male_name1)
print("He thought a place this %s would be worth seeing." % adjective4)

noun1 = input("Enter a noun: ")
food_place = input("Enter a food place: ")

print("He went to this house and realized he liked %s" % noun1)
print("Next to this house was a %s." % food_place)

food = input("Enter food: ")

print("He went to %s and had his favorite meal," % food_place)
