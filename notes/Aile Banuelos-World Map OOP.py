...
EAPT = Room('East Apartments', "HALL", None, None, "WAPT", "You are next to a long hall North and stairs Down.", None,
            "STR")
...
while playing:
    ...
    if "inventory" in command:
        ...
        print(player.inventory[3:5])
        print(player.inventory[5:8])
        print(player.inventory[8:11])
        print(player.inventory[11:14])
        print("")
